...
fake_df = pd.read_csv(r"C:\Users\User\OneDrive\Desktop\projects\archive (4)\News _dataset\Fake.csv", encoding='ISO-8859-1')
true_df = pd.read_csv(r"C:\Users\User\OneDrive\Desktop\projects\archive (4)\News _dataset\True.csv", encoding='ISO-8859-1')
